...
function App() {
  ...
  // Cargar los valores almacenados en el localStorage al iniciar el componente
  useEffect(() => {
    const valoresAlmacenados = JSON.parse(localStorage.getItem('misValores')) || [];
    setIsChecked(valoresAlmacenados);
  }, []);
  ...
  const handleCheckbox = (event) => {
    ...
    localStorage.setItem('misValores', JSON.stringify(isChecked));
